...
float HALL_GetSpeed_RPM(void); // Motorun elektriksel hızını RPM cinsinden döndüren fonksiyon
float HALL_GetElectricalAngle_Rad(void); // Mevcut elektriksel rotor açısını radyan cinsinden döndüren fonksiyon
